...
int ems_show(int out_fd, unsigned int event_id) {
  ...
  // Servidor: (int) retorno (conforme código base) | (size_t) num_rows | (size_t) num_cols | (unsigned int[num_rows * num_cols]) seats
  return s;
}
...
int ems_list_events(int out_fd) {
  ...
  // Servidor: (int) retorno (conforme código base) | (size_t) num_events | (unsigned int[num_events]) ids
  return s;
}
